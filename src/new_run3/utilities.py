...
def load_training_images():
    return load_images_from_dir('/用户/macbookpro/PycharmProjects/CV_Coursework3/resources/training')


def load_testing_images():
    return load_images_from_folder('/用户/macbookpro/PycharmProjects/CV_Coursework3/resources/testing')
